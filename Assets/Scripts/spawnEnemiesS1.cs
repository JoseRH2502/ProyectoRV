...
public class spawnEnemiesS1 : MonoBehaviour
{
    ...
    {
        _isNewEnemy = true;
        Instantiate(_enemy1, new Vector3(RandomPosicion(13,17.45f), 4.5f, RandomPosicion(24, 31)),Quaternion.identity);
        _currentEnemies1++;
    ...
    {
        _isNewEnemy2 = true;
        Instantiate(_enemy2, new Vector3(RandomPosicion(16.3f,20.18f), 3.3f, RandomPosicion(15, 21.5f)), Quaternion.identity);
        _currentEnemies2++;
        yield return new WaitForSeconds(5);
        _isNewEnemy2 = false;
    }
